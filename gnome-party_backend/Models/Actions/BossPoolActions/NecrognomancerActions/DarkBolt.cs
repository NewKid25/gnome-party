...
{
    // Dark Bolt: Deal 10 damage to target enemy
    public sealed class DarkBolt : CharacterAction
    {
        public DarkBolt() : base("Dark Bolt") // Pass the name of the action to the base constructor
        {
            ActionDescription = new CharacterActionDescription("Dark Bolt", "Deal 10 damage to a target enemy"); // Set the action description
        }
